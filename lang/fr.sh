...
MENU_SECTION_SETUP="--- Configuration du Serveur ---"
MENU_OPTION_INITIAL_SETUP="Configuration initiale du serveur (MàJ, Pare-feu, LEMP)"
MENU_OPTION_SETUP_MAIL_SERVER="Configurer le serveur de messagerie (Postfix & Dovecot)"
MENU_OPTION_FAIL2BAN="Renforcer la sécurité (Installer Fail2ban)"

MENU_SECTION_WEBSITE="--- Gestion des Sites Web ---"
MENU_OPTION_ADD_WEBSITE="Ajouter un nouveau site web (avec SSL)"
MENU_OPTION_MANAGE_WEBSITES="Gérer les sites web existants"

MENU_SECTION_USERS="--- Gestion des Utilisateurs ---"
MENU_OPTION_CREATE_SFTP_USER="Créer un utilisateur SFTP"
MENU_OPTION_MANAGE_SFTP_USERS="Gérer les utilisateurs SFTP"
MENU_OPTION_MANAGE_MAIL_USERS="Gérer les comptes de messagerie"

MENU_SECTION_UTILS="--- Utilitaires ---"
MENU_OPTION_BACKUP="Sauvegarder un site web"
MENU_OPTION_RESTORE="Restaurer un site web"

MENU_OPTION_EXIT="Quitter"
...
# --- Initial Setup Flow ---
MSG_INITIAL_SETUP_OVERVIEW="Ce processus effectuera les actions suivantes :\n1. Configuration du pare-feu (UFW)\n2. Installation de la pile LEMP (Nginx, MariaDB, PHP)\n3. Sécurisation de l'installation de MariaDB.\nCela peut prendre plusieurs minutes."
MSG_FIREWALL_EXPLANATION="Le script va maintenant configurer le pare-feu UFW avec les règles suivantes :\n- Refuser tout le trafic entrant par défaut\n- Autoriser tout le trafic sortant\n- Autoriser SSH (port 22), HTTP (port 80) et HTTPS (port 443)"
MSG_LEMP_EXPLANATION="Le script va maintenant installer les composants principaux de la pile LEMP : Nginx, MariaDB, et la dernière version de PHP disponible avec les modules courants (mysql, curl, gd, mbstring, xml, zip)."
...
MSG_MARIADB_SECURITY_EXPLANATION="Le script va maintenant sécuriser l'installation de MariaDB en :\n- Définissant un mot de passe aléatoire et sécurisé pour l'utilisateur 'root'.\n- Supprimant les utilisateurs anonymes.\n- Interdisant la connexion root à distance.\n- Supprimant la base de données 'test'."
MSG_MARIADB_PASSWORD_NOTICE_HEADER="!! IMPORTANT : Mot de passe root de MariaDB défini !!"
MSG_MARIADB_PASSWORD_NOTICE_BODY="Le mot de passe root pour MariaDB a été défini avec la valeur ci-dessous. \nVeuillez SAUVEGARDER CE MOT DE PASSE dans un endroit sûr. Vous en aurez besoin pour gérer vos bases de données."
MSG_MARIADB_PASSWORD_CONFIRM="Appuyez sur une touche pour confirmer que vous avez sauvegardé ce mot de passe."
...
MSG_CERTBOT_EXPLANATION="Pour sécuriser votre site web avec HTTPS, le script va utiliser Certbot pour obtenir automatiquement un certificat SSL gratuit de Let's Encrypt."
...
PROMPT_ENTER_EMAIL="Entrez votre adresse e-mail (pour les notifications de certificat SSL, ex: admin@example.com) :"
...
MSG_WARN_MAIL_ADVANCED_SETUP="Ceci est une configuration avancée. Vous DEVEZ posséder un nom de domaine et avoir correctement configuré les enregistrements DNS suivants pour qu'ils pointent vers ce serveur :\n- Un enregistrement 'A' pour votre nom d'hôte (ex: mail.example.com)\n- Un enregistrement 'MX' pour votre domaine (ex: example.com) qui pointe vers votre nom d'hôte."
...
MSG_MAIL_POSTFIX_EXPLANATION="Configuration de Postfix pour l'envoi et la réception d'e-mails."
...
MSG_MAIL_DOVECOT_EXPLANATION="Configuration de Dovecot pour IMAP, permettant aux clients de messagerie de se connecter."
...
MSG_MAIL_FIREWALL_EXPLANATION="Ouverture des ports liés à la messagerie dans le pare-feu : SMTP (25), Soumission (587) et IMAPS (993)."
...
MSG_INFO_ADD_MAIL_USERS_HOW_TO="Vous pouvez maintenant ajouter des comptes de messagerie depuis le menu 'Gestion des Comptes de Messagerie'."
...
MSG_SFTP_JAIL_EXPLANATION="L'utilisateur sera confiné dans ce répertoire et ne pourra pas accéder à d'autres parties du système de fichiers. Pour des raisons de sécurité, ce répertoire doit appartenir à l'utilisateur 'root'."
