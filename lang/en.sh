...
# --- Language Selection ---
PROMPT_CHOOSE_LANGUAGE="Please choose a language: [1] English, [2] Français"
...
MENU_SECTION_SETUP="--- Server Setup ---"
MENU_OPTION_INITIAL_SETUP="Initial Server Setup (Update, Firewall, LEMP)"
MENU_OPTION_SETUP_MAIL_SERVER="Setup Mail Server (Postfix & Dovecot)"
MENU_OPTION_FAIL2BAN="Harden Security (Install Fail2ban)"

MENU_SECTION_WEBSITE="--- Website Management ---"
MENU_OPTION_ADD_WEBSITE="Add New Website (with SSL)"
MENU_OPTION_MANAGE_WEBSITES="Manage Existing Websites"

MENU_SECTION_USERS="--- User Management ---"
MENU_OPTION_CREATE_SFTP_USER="Create SFTP User"
MENU_OPTION_MANAGE_SFTP_USERS="Manage SFTP Users"
MENU_OPTION_MANAGE_MAIL_USERS="Manage Email Accounts"

MENU_SECTION_UTILS="--- Utilities ---"
MENU_OPTION_BACKUP="Backup Website"
MENU_OPTION_RESTORE="Restore Website"
...
# --- Initial Setup Flow ---
MSG_INITIAL_SETUP_OVERVIEW="This process will perform the following actions:\n1. Configure the firewall (UFW)\n2. Install the LEMP stack (Nginx, MariaDB, PHP)\n3. Secure the MariaDB installation.\nThis may take several minutes to complete."
MSG_FIREWALL_EXPLANATION="The script will now configure the UFW firewall with the following rules:\n- Deny all incoming traffic by default\n- Allow all outgoing traffic\n- Allow SSH (port 22), HTTP (port 80), and HTTPS (port 443)"
MSG_LEMP_EXPLANATION="The script will now install the core LEMP stack components: Nginx, MariaDB, and the latest available PHP version with common modules (mysql, curl, gd, mbstring, xml, zip)."
...
MSG_MARIADB_SECURITY_EXPLANATION="The script will now secure the MariaDB installation by:\n- Setting a random, secure password for the 'root' user.\n- Removing anonymous users.\n- Disallowing remote root login.\n- Removing the 'test' database."
MSG_MARIADB_PASSWORD_NOTICE_HEADER="!! IMPORTANT: MariaDB Root Password Set !!"
MSG_MARIADB_PASSWORD_NOTICE_BODY="The root password for MariaDB has been set to the value below. \nPLEASE SAVE THIS PASSWORD in a secure location. You will need it to manage your databases."
MSG_MARIADB_PASSWORD_CONFIRM="Press any key to confirm you have saved this password."
...
MSG_CERTBOT_EXPLANATION="To secure your website with HTTPS, the script will use Certbot to automatically obtain a free SSL certificate from Let's Encrypt."
...
PROMPT_ENTER_EMAIL="Enter your email address (for SSL certificate notices, e.g., admin@example.com):"
...
MSG_WARN_MAIL_ADVANCED_SETUP="This is an advanced setup. You MUST have a registered domain name and have correctly configured the following DNS records to point to this server:\n- An 'A' record for your hostname (e.g., mail.example.com)\n- An 'MX' record for your domain (e.g., example.com) pointing to your hostname."
...
MSG_MAIL_POSTFIX_EXPLANATION="Configuring Postfix for sending and receiving emails."
...
MSG_MAIL_DOVECOT_EXPLANATION="Configuring Dovecot for IMAP, allowing email clients to connect."
...
MSG_MAIL_FIREWALL_EXPLANATION="Opening mail-related ports in the firewall: SMTP (25), Submission (587), and IMAPS (993)."
...
MSG_INFO_ADD_MAIL_USERS_HOW_TO="You can now add email accounts from the 'Manage Email Accounts' menu."
...
MSG_SFTP_JAIL_EXPLANATION="The user will be confined to this directory and will not be able to access other parts of the filesystem. For security, this directory must be owned by the 'root' user."
...
MENU_LIST_WEBSITES_HEADER="--- Available Websites ---"
MENU_LIST_WEBSITES_ENABLED="(Enabled)"
MENU_LIST_WEBSITES_DISABLED="(Disabled)"
